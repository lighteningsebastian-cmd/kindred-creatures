        ...
        <Reveal>
          <div className="flex flex-col gap-3">
            ...
            <p className="max-w-md text-muted">
              Four pieces, one portrait. Pick the one you will reach for most.
            </p>
          </div>
        </Reveal>
            ...
            if (isFilled) {
              return (
                ...
                >
                  <Link
                    href={href}
                    className="group relative flex h-full min-h-[220px] items-end overflow-hidden rounded-2xl border border-line bg-surface"
                  >
                    <Image
                    ...
                    />
                    <div className="relative m-4 rounded-2xl bg-base/95 px-4 py-3">
                      <p className="font-display text-lg font-semibold tracking-tight text-ink">
                        {product.name}
                      </p>
                      <p className="text-sm text-muted">from {price}</p>
                    </div>
                  </Link>
                </Reveal>
              );
